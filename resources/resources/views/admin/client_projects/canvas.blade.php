    ...
    <div class="panel-body-dr">
        <div class="row text-left quick-top-stats">
            <div class="col-lg-5ths col-md-5ths">
                <div class="row">
                    <div class="col-md-9">
                        <a href="#" data-cview="invoices_1"
                            onclick="dt_custom_view('invoices_1','.table-invoices','invoices_1',true); return false;">
                            <h5 class="blue-text">
                                @lang('others.statistics.total-client-projects')
                            </h5>
                        </a>
            ...
            <div class="col-lg-5ths col-md-5ths">
                <div class="row">
                    <div class="col-md-7">
                        <a href="#" data-cview="invoices_2"
                            onclick="dt_custom_view('invoices_2','.table-invoices','invoices_2',true); return false;">
                            <h5 class="blue-text">
            ...
            <div class="col-lg-5ths col-md-5ths">
                <div class="row">
                    <div class="col-md-7">
                        <a href="#" data-cview="invoices_4"
                            onclick="dt_custom_view('invoices_4','.table-invoices','invoices_4',true); return false;">
                            <h5 class="blue-text">
        ...
        (function(root, factory) {
            ...
            var CanvasRenderer = function(el, options) {
                ...
                this.draw = function(percent) {
                    ...
                    if (!!options.scaleColor || !!options.trackColor) {
                        ...
                        if (ctx.getImageData && ctx.putImageData) {
                            if (!cachedBackground) {
                                drawBackground();
                                cachedBackground = ctx.getImageData(0, 0, options.size * scaleBy, options
                                    .size * scaleBy);
                            } else {
                ...
                this.animate = function(from, to) {
                    ...
                    var animation = function() {
                        ...
                        var currentValue = options.easing(this, process, from, to - from, options
                            .animate.duration);
            ...
            var EasyPieChart = function(el, opts) {
                var defaultOptions = {
                    ...
                    easing: function(x, t, b, c,
                        d) { // more can be found here: http://gsgd.co.uk/sandbox/jquery/easing/
                        t = t / (d / 2);
                        if (t < 1) {
                            return c / 2 * t * t + b;
                        }
                ...
                var init = function() {
                    ...
                    for (var i in defaultOptions) {
                        if (defaultOptions.hasOwnProperty(i)) {
                            options[i] = opts && typeof(opts[i]) !== 'undefined' ? opts[i] : defaultOptions[
                                i];
                    ...
                    if (typeof(options.easing) === 'string' && typeof(jQuery) !== 'undefined' && jQuery
                        .isFunction(jQuery.easing[options.easing])) {
