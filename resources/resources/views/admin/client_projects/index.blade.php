...
@section('breadcrumb-title')
    <h3>@lang('global.client-projects.title')</h3>
@endsection
...
@section('content')
    ...
    <p>
        @can('client_project_create')
            <a href="{{ route('admin.client_projects.create') }}" class="btn btn-success"><i
                    class="fa fa-plus"></i>&nbsp;@lang('global.app_add_new')</a>
        @endcan
    ...
    <ul class="list-inline">
        <li><a href="{{ route('admin.client_projects.index') }}"
                style="{{ request('show_deleted') == 1 ? '' : '    font-weight: 700' }}">@lang('global.app_all')
                <?php
        ...
        @can('client_project_delete')
            |
            <li><a href="{{ route('admin.client_projects.index') }}?show_deleted=1"
                    style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">@lang('global.app_trash')
