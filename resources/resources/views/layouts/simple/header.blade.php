              ...
              <div class="row">
                <div class="col mega-box">
                  ...
                  <div class="link-section icon">
                    ...
                    <ul>
                      <li><a href="error-400')}}">Error page 400</a></li>
                      <li><a href="error-401')}}">Error page 401</a></li>
                      <li><a href="error-403')}}">Error page 403</a></li>
                      <li><a href="error-404')}}">Error page 404</a></li>
                      <li><a href="error-500')}}">Error page 500</a></li>
                      <li><a href="error-503')}}">Error page 503</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section doted">
                    ...
                    <ul>
                      ...
                      <li><a href="login-one')}}">Login with image</a></li>
                      <li><a href="login-bs-validation')}}">Login with validation</a></li>
                      <li><a href="sign-up')}}">Sign Up</a></li>
                      <li><a href="sign-up-one')}}">SignUp with image</a></li>
                      <li><a href="sign-up-two')}}">SignUp with image</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section dashed-links">
                    ...
                    <ul>
                      ...
                      <li><a href="login-bs-validation')}}">Login validation</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section">
                    ...
                    <ul>
                      <li class="ps-0"><a href="basic-template')}}">Basic Email</a></li>
                      <li class="ps-0"><a href="email-header')}}">Basic With Header</a></li>
                      <li class="ps-0"><a href="template-email')}}">Ecomerce Template</a></li>
                      <li class="ps-0"><a href="template-email-2')}}">Email Template 2</a></li>
                      <li class="ps-0"><a href="ecommerce-templates')}}">Ecommerce Email</a></li>
                      <li class="ps-0"><a href="email-order-success')}}">Order Success</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section">
                    ...
                    <ul class="svg-icon">
                      <li><a href="comingsoon')}}"> <i data-feather="file"> </i>Coming-soon</a></li>
                      <li><a href="comingsoon-bg-video')}}"> <i data-feather="film"> </i>Coming-video</a></li>
                      <li><a href="comingsoon-bg-img')}}"><i data-feather="image"> </i>Coming-Image</a></li>
                    </ul>
                    <div>
                      <h6>Other Soon</h6>
                    </div>
                    <ul class="svg-icon">
                      <li><a class="txt-secondary" href="sample-page')}}"> <i data-feather="airplay"></i>Sample Page</a></li>
                    </ul>
                  </div>
                </div>
              </div>
           ...
           <li>
            ...
            <li>
              ...
              <ul class="header-level-sub-menu">
                <li>
                  <a href="user-profile')}}" data-original-title="" title=""> <i data-feather="user"></i><span>User Profile</span></a>
                </li>
                <li>
                  <a href="edit-profile')}}" data-original-title="" title=""> <i data-feather="user-minus"></i><span>User Edit</span></a>
                </li>
                <li>
                  <a href="user-cards')}}" data-original-title="" title=""> <i data-feather="user-check"></i><span>Users Cards</span></a>
                </li>
              </ul>
            </li>
            <li>
              <a href="kanban') }}" data-original-title="" title=""> <i data-feather="airplay"></i><span>Kanban Board</span></a>
            </li>
            <li>
              <a href="bookmark') }}" data-original-title="" title=""> <i data-feather="heart"></i><span>Bookmark</span></a>
            </li>
            <li>
              <a href="social-app') }}" data-original-title="" title=""> <i data-feather="zap"></i><span>Social App </span></a>
            </li>
          </ul>
        </li>
      </ul> --}}
      ...
      <ul class="nav-menus">
        <li class="language-nav">
          <div class="translate_wrapper">
            ...
            <div class="more_lang">
              <a href="lang', 'en' )}}" class="{{ (App::getLocale()  == 'en') ? 'active' : ''}}">
              ...
              <a href="lang' , 'de' )}}" class="{{ (App::getLocale()  == 'de') ? 'active' : ''}} ">
              ...
              <a href="lang' , 'es' )}}" class="{{ (App::getLocale()  == 'en') ? 'active' : ''}}">
              ...
              <a href="lang' , 'fr' )}}" class="{{ (App::getLocale()  == 'fr') ? 'active' : ''}}">
              ...
              <a href="lang' , 'pt' )}}" class="{{ (App::getLocale()  == 'pt') ? 'active' : ''}}">
              ...
              <a href="lang' , 'cn' )}}" class="{{ (App::getLocale()  == 'cn') ? 'active' : ''}}">
              ...
              <a href="lang' , 'ae' )}}" class="{{ (App::getLocale()  == 'ae') ? 'active' : ''}}">
